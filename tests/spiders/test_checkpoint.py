...
class TestCheckpointManagerInit:
    ...
    def test_init_with_string_path(self):
        ...
        assert "tmp" in str(manager.crawldir) and "test_crawl" in str(manager.crawldir)
    ...
    def test_checkpoint_file_path(self):
        ...
        assert str(manager._checkpoint_path).endswith("test_crawl/checkpoint.pkl") or str(manager._checkpoint_path).endswith("test_crawl\\checkpoint.pkl")
